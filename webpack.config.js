 ...
 */
// generated on 2017-10-31 using generator-openmrs-owa 0.6.0
'use strict';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/testowa/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/testowa`,
	  css: `${__dirname}/app/css/testowa.css`,
	  vendor : [
